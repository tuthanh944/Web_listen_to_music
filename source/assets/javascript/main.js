...
const app = {
    ...
    songsData : [
        {
            background: './assets/img/song-images/0.webp',
            name: 'Anh Đã Lạc Vào',
        ...
        {
            background: './assets/img/song-images/1.webp',
        ...
        {
            background: './assets/img/song-images/2.jpeg',
        ...
        {
            background: './assets/img/song-images/3.webp',
            name: 'Gieo Quẻ',
        ...
        {
            background: './assets/img/song-images/4.webp',
            name: 'Vui Lắm Nha',
        ...
        {
            background: './assets/img/song-images/5.webp',
        ...
        {
            background: './assets/img/song-images/6.webp',
        ...
        {
            background: './assets/img/song-images/7.webp',
        ...
        {
            background: './assets/img/song-images/8.jpg',
        ...
        {
            background: './assets/img/song-images/9.webp',
            name: 'Không Bằng',
        ...
        {
            background: './assets/img/song-images/10.webp',
        ...
        {
            background: './assets/img/song-images/11.webp',
        ...
        {
            background: './assets/img/song-images/12.webp',
        ...
        {
            background: './assets/img/song-images/13.webp',
            name: '2 Phút Hơn',
        ...
        {
            background: './assets/img/song-images/14.webp',
    ...
    renderPlayList : function (playListElement, songsData) {
        const htmls = songsData.map((song, index) => {
            return `
                <!-- song-images-item-playing--active-onplay song-images-item--active song-images-item-playbtn--active -->
                <li class="songs-item js__song-item0 ${index == this.currentIndex ? 'song-images-item--active' : ''} " data-index="${index}">
    ...
    renderPlayList1 : function (playListElement, songsData) {
        const htmls = songsData.map((song, index) => {
            return `
                <!-- song-images-item-playing--active-onplay song-images-item--active song-images-item-playbtn--active -->
                <li class="songs-item js__song-item1 ${index == this.currentIndex ? 'song-images-item--active song-images-item-playbtn--active' : ''} " data-index="${index}">
                    <div class="songs-item-left">
    ...
    scrollToActiveSong: function () {
        setTimeout(() => {
          $(".song-images-item--active").scrollIntoView({
            behavior: "smooth",
            block: "nearest"
          });
        }, 300);
    ...
    handleEvents: function () {
        const _this = this;
        const songTyms = $$('.song-images-item-right-tym');
        ...
        songItems[this.currentIndex].classList.add('song-images-item-playbtn--active');

        
        songTyms.forEach((songTym, index) => {
            songTym.onclick = function() {
                songTym.classList.toggle('song-images-item-right-tym--active');
            }
        });
        ...
        audio.onplay = function () {
            ...
            songItems[_this.currentIndex].classList.add('song-images-item-playing--active-onplay');
            songItems[_this.currentIndex].classList.add('song-images-item--active');
            songItems[_this.currentIndex].classList.remove('song-images-item-playbtn--active');

            songItemsOption1[_this.currentIndex].classList.add('song-images-item-playing--active-onplay');
            songItemsOption1[_this.currentIndex].classList.add('song-images-item--active');
            songItemsOption1[_this.currentIndex].classList.remove('song-images-item-playbtn--active');
        ...
        audio.onpause = function () {
            ...
            songItems[_this.currentIndex].classList.remove('song-images-item-playing--active-onplay');
            songItems[_this.currentIndex].classList.add('song-images-item-playbtn--active');
            songItemsOption1[_this.currentIndex].classList.remove('song-images-item-playing--active-onplay');
            songItemsOption1[_this.currentIndex].classList.add('song-images-item-playbtn--active');
            const nextSongItems = $$('.nextsong__item')
        ...
        deleteActive = function() {
            songItems.forEach((songItem, index) => {
                songItem.classList.remove('song-images-item-playing--active-onplay');
                songItem.classList.remove('song-images-item--active');
                songItem.classList.remove('song-images-item-playbtn--active');
            });
        }
